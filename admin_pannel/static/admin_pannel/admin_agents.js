    ...
    document.getElementById('agentForm').addEventListener('submit', async function (e) {
        ...
        if (response.ok) {
            ...
            const rowHTML = `
                ...
                <td class="statut">${data.down ? "Actif" : "Inactif"}</td>
                <td>
...
function attachAgentActionListeners() {
    document.querySelectorAll('.edit-agent').forEach(link => {
        link.addEventListener('click', function (e) {
            ...
            document.getElementById('statut').checked = row.dataset.down === "true";
            document.getElementById('agentForm').dataset.agentId = row.dataset.id;
        });
    });
